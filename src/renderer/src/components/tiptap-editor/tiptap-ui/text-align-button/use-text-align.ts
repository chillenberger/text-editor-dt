...
// --- Icons ---
import { AlignCenterIcon } from '@renderer/components/tiptap-editor/tiptap-icons/align-center-icon'
import { AlignJustifyIcon } from '@renderer/components/tiptap-editor/tiptap-icons/align-justify-icon'
import { AlignLeftIcon } from '@renderer/components/tiptap-editor/tiptap-icons/align-left-icon'
import { AlignRightIcon } from '@renderer/components/tiptap-editor/tiptap-icons/align-right-icon'

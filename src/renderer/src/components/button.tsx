export default function SecondaryButton(props: {
  ...
  return (
    <button
      className={`${colorClasses} ${props.className || ''} text-custom-gray-4 hover:text-custom-gray-3  hover:border-t-0 hover:border-r-0 font-bold rounded-md text-2xl active:border active:border-transparent hover:cursor-pointer`}

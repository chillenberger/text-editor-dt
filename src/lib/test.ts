...
describe('findDir', () => {
  test('find existing dir', () => {
    ...
    expect(dir).toEqual({
      title: 'subsubdir1',
      children: [{ title: 'file3.txt', content: 'This is file 3' }]
    })
  })
  ...
  children: [
    { title: 'file1.txt', content: 'This is file 1' },
    {
      ...
      children: [
        ...
        { title: 'subsubdir1', children: [{ title: 'file3.txt', content: 'This is file 3' }] }
      ]
    },
    { title: 'subdir2', children: [{ title: 'file4.txt', content: 'This is file 4' }] }
  ]
}

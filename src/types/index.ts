...
export const ChatActionsSchema = z.object({
  action_type: z
    .enum(['Edited File', 'Created File', 'Deleted File'])
    .describe('The type of system action taken.'),
...
export const ChatSchema = z.object({
  ...
  special_instructions: z
    .nullable(z.string())
    .describe(
      'Any special instructions related to the response. Do not feel obligated to fill this out.'
    ),
